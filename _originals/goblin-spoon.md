...
{% include relBase.html %}
 ...
 <div id="heroImage">
        <img src="{{ relBase }}img/gallery/goblinspoon1.jpg"></div>
 <section id="details">
<div id="gallery">
        <img src="{{ relBase }}img/gallery/goblinspoon2.jpg" id="img2" data-hystmodal="#myModal2">
        <img src="{{ relBase }}img/gallery/goblinspoon3.jpg" id="img2" data-hystmodal="#myModal3">
