...
<style>div#heroImage{grid-row-start: 2;}section#details{grid-row-start:3;}div#gallery{display:grid;grid-template-columns:calc(33.3% - 1.3rem) calc(33.3% - 1.3rem) calc(33.3% - 1.3rem);grid-gap:2rem;margin-bottom:5rem;}div#gallery img, div#heroImage img{width:100%;}section#details{width:85rem;margin:auto;}section#details article{grid-gap:0;}</style>
