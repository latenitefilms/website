...
<style>div#heroImage{grid-row-start: 2;}section#details{grid-row-start:3;}div#gallery{display:grid;grid-template-columns:33% 33% 33%}div#gallery img{width:100%;}</style>
